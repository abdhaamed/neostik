<div class="bg-white border-b border-gray-200 p-4 flex items-center justify-between">
    <div class="flex items-center space-x-3">
        <span class="text-sm font-medium text-gray-700" data-label="fleetId">HD-23818981289</span>
...
<div id="contentFleet" class="tab-content p-4">
    @include('components.content-dashboard.fleetDevice.detail.fleet')
</div>

<!-- Device Detail -->
<div id="contentDevice" class="tab-content hidden p-4">
    @include('components.content-dashboard.fleetDevice.detail.device')
</div>
