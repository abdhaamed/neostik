...
<head>
    ...
    <title>Admin Login - Fleet Management System</title>
    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form method="POST" action="{{ route('login.admin.post') }}">
                ...
                <!-- Submit Button -->
                <button type="submit" 
                        class="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-300 shadow-md hover:shadow-lg">
                    Sign In as Admin
                </button>
            </form>
        </div>
